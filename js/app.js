(() => {
  ...
  const R = {
      attachEvents: function () {
        ...
        (e.onTouchStart = _.bind(e)),
          ...
          (e.onClick = V.bind(e)),
          i.touch && !j && (t.addEventListener("touchstart", W), (j = !0)),
          q(e, "on");
      },
  ...
  function ie(e) {
    ...
    function h(e) {
      return (
        ...
        !(
          ...
          w() - d < t.params.mousewheel.thresholdTime
        ) &&
        ((e.delta >= 6 && w() - d < 60) ||
          (e.direction < 0
    ...
    function f(e) {
      ...
      if (
        ("container" !== t.params.mousewheel.eventsTarget &&
          (o = g(t.params.mousewheel.eventsTarget)),
      ...
      if (r.forceToAxis)
        ...
        d = Math.abs(u.pixelX) > Math.abs(u.pixelY) ? -u.pixelX * p : -u.pixelY;
      if (0 === d) return !0;
      r.invert && (d = -d);
      ...
      if (
        ...
        const e = { time: w(), delta: Math.abs(d), direction: Math.sign(d) },
          i =
            l &&
            e.time < l.time + 500 &&
            e.delta <= l.delta &&
    ...
    function m(e) {
      let s = t.$el;
      "container" !== t.params.mousewheel.eventsTarget &&
        (s = g(t.params.mousewheel.eventsTarget)),
        s[e]("mouseenter", p),
        s[e]("mouseleave", u),
        s[e]("wheel", f);
    }
  ...
  function le(e) {
    ...
    function x(e) {
      ...
      l.touch
        ? (o[p](i.start, T, d), o[p](i.move, y, d), o[p](i.end, C, c))
        : (o[p](n.start, T, d), r[p](n.move, y, d), r[p](n.end, C, c));
    }
    function S() {
      ...
      0 === r.length &&
        ...
        i.draggable && t.params.scrollbar.el && x("on"),
        n &&
      ...
      if (document.querySelector(".page")) {
        ...
        e.on("slideChange", function () {
          ...
          0 !== e.activeIndex
            ...
            : (t.classList.remove("scrolled"), console.log("test"));
        });
      }
      document.querySelector(".swiper-gallery") &&
        (e = new te(".swiper-gallery", {
          modules: [oe, de],
          observer: !0,
          observeParents: !0,
          parallax: !0,
          ...
          breakpoints: {
            ...
            768: { slidesPerView: 3.5, spaceBetween: 60 },
          },
        })),
        document.querySelector(".swiper-gallery-bg") &&
          (t = new te(".swiper-gallery-bg", {
            modules: [oe, de],
            observer: !0,
            observeParents: !0,
            centeredSlides: !0,
        ...
        document.querySelector(".swiper-gallery") &&
          (e.on("slideChange", function () {
            const t = document.querySelector(".gallery__text-content");
            0 !== e.activeIndex
              ? t.classList.add("gallery__text-content_hide")
              : t.classList.remove("gallery__text-content_hide");
          }),
  ...
  setTimeout(() => {
    ...
    document.addEventListener("click", function (e) {
      if (e.target.closest(".start__arrow")) {
        document.querySelector(".page").swiper.slideNext();
      }
    }),
    (window.FLS = !0),
    (function (e) {
